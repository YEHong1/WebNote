...
CommonJs的核心变量：` exports、module.exports、require `
...
CommonJs中真正导出的其实是 module.exports， 而不是 exports

exports 是  module.exports的一份浅拷贝
...
想要在html中使用需要在 script标签添加 type 属性，值为 module
